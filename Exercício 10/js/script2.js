...
function listarVeiculos(){
    ...
    var vehicle1JSON = JSON.stringify(vehicle1);
    localStorage.setItem('Vehicle 1', vehicle1JSON);
    var vehicle2JSON = JSON.stringify(vehicle2);
    localStorage.setItem('Vehicle 2', vehicle2JSON);
}
